...
public partial class InkStory : Resource
{
    ...
    [Signal]
    public delegate void ErroredEventHandler(string message, string type);
    ...
    public Story RuntimeStory => runtimeStory;
    ...
    {
        _ = EmitSignal(SignalName.Errored, message, type.ToString());
    }
